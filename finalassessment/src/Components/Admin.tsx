...
export const Admin = (props: Props) => {
  ...
  const handlePlansModalOpen = () => setOpenPlansModal(true);
  const handlePlansModalClose = () => setOpenPlansModal(false);
  ...
  const handleplansubmit = () => {
    plandata.push({
      ...
      nameplan: plan,
      planprice: planprice,
      selectplan: inputValue,
      feature: userinfo.languages,
      color: false,
    });
  ...
  console.log(inputValue, "Complete");
        ...
        >
          <Toolbar>
            ...
            <Typography
              ...
              style={{ maxWidth: "90%" }}
            >
              Welcome Admin {value.profilename}
            </Typography>
            <IconButton
              color="inherit"
              aria-label="open drawer"
        ...
        >
          ...
          <Grid container style={{ display: "block" }}>
            ...
            <Grid item lg={12}>
              ...
              <AddItemsButton onClick={handleModalOpen}>
                Add Items
              </AddItemsButton>
              <AddItemsButton onClick={handlePlansModalOpen}>
                Add Plans
              </AddItemsButton>
          ...
          <Modal keepMounted open={openmodal} onClose={handleModalClose}>
            <Box
              style={{
                height: "300px",
                width: "250px",
                    ...
                    <div style={{ textAlign: "left", color: "white" }}>
                      ...
                      <div>
                        <input
                          type="checkbox"
                          name="languages"
                          value="Under 30 mins Delivery"
                          id="flexCheckDefault"
                          onChange={handleChange}
                        />
                        <label htmlFor="flexCheckDefault">
                          Under 30 mins Delivery
                        </label>
                      </div>
                      <div>
                        <input
                      ...
                      <div>
                        <input
                          ...
                          onChange={handleChange}
                        />
                        <label htmlFor="flexCheckDefault">Extra Discount</label>
                      </div>
                      ...
                      <div>
                        <div>
                          <input
                            type="checkbox"
                            name="languages"
                            value=" Earn points on each order"
                            id="flexCheckDefault"
                            onChange={handleChange}
                          />
                          <label htmlFor="flexCheckDefault">
